...
internal static class UiTextCaptureService
{
        ...
        IReadOnlyDictionary<string, string> inheritedContext)
    {
        switch (element.ValueKind)
        {
            case JsonValueKind.Object:
                var objectContext = ExtendContext(inheritedContext, element);
    ...
    private static Dictionary<string, string> ExtendContext(IReadOnlyDictionary<string, string> inherited,
        JsonElement element)
    {
